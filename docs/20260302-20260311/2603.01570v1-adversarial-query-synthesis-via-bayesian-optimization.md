...
tags: ["query:ai-ux"]
score: 7.0
evidence: 用于自动查询合成的贝叶斯优化
tldr: 随着机器学习在数据库系统中的应用日益增多，高质量的基准测试负载变得至关重要。本文提出一种基于贝叶斯优化的对抗性查询合成技术，旨在自动搜索具有挑战性的基准查询，以减少人工设计成本。实验表明，该方法生成的查询在优化空间上比现有基准高出两倍以上，显著提升了测试的有效性。
selection_source: fresh_fetch
motivation: 传统的数据库基准测试负载通常需要大量人工设计，且难以覆盖复杂的机器学习集成场景。
method: 采用贝叶斯优化技术自动搜索并合成具有高优化难度的对抗性基准查询。
result: 初步实验显示，该方法生成的查询比现有基准提供了超过两倍的优化提升空间。
conclusion: 自动化对抗性查询合成能有效降低基准测试的开发成本，并提供更具挑战性的测试用例。
---
